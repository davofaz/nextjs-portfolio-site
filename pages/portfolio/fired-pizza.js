        ...
        <main className="px-4 max-w-4xl mx-auto mt-16 antialiased">
            ...
            >
              ...
              <Link
                    ...
                    passHref={true}
                ><a><button className="inline-flex border rounded-lg p-2 bg-gray-200 dark:bg-gray-700"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{marginRight:'0.5em'}}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg> Fired Pizza website</button></a></Link>
                </div>
            </FadeIn>
