...
const About = () => {
    return (
        <div className="grid grid-cols-6 gap-2 md:grid-cols-4 gap-y-0 border-8 border-b-8 border-t-8 border-black bg-white dark:border-black dark:bg-black">
            ...
            <h3 class="text-black text-2xl md:text-4xl md:p-8 uppercase font-thin dark:text-white"> About Me</h3>
            </div>
            <div className="text-black dark:bg-black col-span-4 border-black  mb-0 pb-0 dark:text-white md:border-0 text-justify">
                        <p className="p-4">
