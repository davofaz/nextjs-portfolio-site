...
const About = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row md:pt-32">
        <div
                className="relative sm:basis-1/3 lg:basis-1/2" 
                style={{
         ...
         <div className="p-6 md:pt-0 text-justify dark:text-gray-400 sm:basis-2/3 lg:basis-1/2">
              ...
              <p className="pb-6">My process is well-defined: I kick off each project with comprehensive business and user research, followed by a thorough review of existing websites or apps. Wireframing is my canvas for constructing layouts, and from there, I meticulously build and refine the final designs, rigorously testing for accessibility.</p>
